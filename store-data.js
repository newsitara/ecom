...
const I18N_DICT = {
  en: {
    ...
    announcement_promo: "USE PROMO CODE SITARA15 FOR 15% OFF INAUGURAL DROP",
    hero_capsule: "INAUGURAL COLLECTION",
    hero_headline: "PREMIUM APPAREL & BESPOKE ESSENTIALS",
    hero_subtext: "Discover contemporary silhouettes, heavyweight fabrics, and tailored streetwear designed for everyday luxury.",
    hero_shop_all: "Shop All Pieces",
    hero_explore: "Explore Departments",
    ...
    shelf_archive: "Shop Complete Archive",
  ...
  ar: {
    ...
    announcement_promo: "استخدم الرمز الترويجي SITARA15 لخصم 15%",
    hero_capsule: "المجموعة الافتتاحية",
    hero_headline: "أزياء فاخرة وأساسيات مصممة خصيصاً",
    hero_subtext: "اكتشف أحدث التصاميم العصرية والأقمشة الفاخرة المصممة للأناقة اليومية.",
    hero_shop_all: "تسوق جميع القطع",
    hero_explore: "استكشف الأقسام",
    flash_tag: "عرض خاطف",
    ...
    shelf_archive: "تسوق الأرشيف الكامل",
  ...
  ur: {
    ...
    hero_headline: "پریمیم ملبوسات اور نفیس دستکاری",
    hero_subtext: "شاندار اسٹریٹ ویئر ڈیزائن اور پائیدار کاٹن سے تیار کردہ شاہکار ملبوسات۔",
    hero_shop_all: "تمام ملبوسات دیکھیں",
    hero_explore: "کیٹیگریز دیکھیں",
    flash_tag: "خصوصی آفر",
    ...
    shelf_most_wanted: "مشہور اور پسندیدہ ملبوسات",
